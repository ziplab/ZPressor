...
base_command = """
CUDA_VISIBLE_DEVICES=[cuda_idx] python -m src.main +experiment=re10k_4_view \
checkpointing.pretrained_model=pretrained/pixelsplat-re10k-baseline-n200-256x256.ckpt \
mode=test \
