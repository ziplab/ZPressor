...
class ModelWrapper(LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        if self.test_cfg.compute_scores:
            ...
            # Print PSNR, SSIM, LPIPS and scene index  
            print(f"psnr: {self.test_step_outputs[f'psnr'][-1]}, ssim: {self.test_step_outputs[f'ssim'][-1]}, lpips: {self.test_step_outputs[f'lpips'][-1]}, scene: {batch['scene']}")
